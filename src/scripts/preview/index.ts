...
generatePreview('fileIcons', basicFileIcons, 5, ['virtual', 'video', 'coldfusion', 'disc']);
generatePreview('folderIcons', folderThemes, 5, ['folder-wakatime', 'folder-phpmailer', 'folder-aurelia', 'folder-ansible']);
