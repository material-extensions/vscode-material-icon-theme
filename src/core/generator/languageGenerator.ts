 ...
 */
const setLanguageIdentifiers = (iconName: string, languageIds: string[]): Partial<Manifest> => {
 ...
 */
const getCustomIcons = (languageAssociations: IconAssociations | undefined): LanguageIcon[] => {
