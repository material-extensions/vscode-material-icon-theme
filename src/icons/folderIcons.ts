...
export const folderIcons: FolderTheme[] = [
    {
        ...
        icons: [
            ...
            { name: 'folder-ngrx-store', folderNames: ['stores', 'store'], enabledFor: [IconPack.Ngrx] },
            ...
            { name: 'folder-redux-store', folderNames: ['stores', 'store'], enabledFor: [IconPack.Redux] },
            ...
            { name: 'folder-vuex-store', folderNames: ['stores', 'store'], enabledFor: [IconPack.Vuex] },
