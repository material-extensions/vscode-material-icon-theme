...
export const folderIcons: FolderTheme[] = [
    {
        ...
        icons: [
            ...
            { name: 'folder-api', folderNames: ['api', 'apis', 'Api']},
            { name: 'folder-app', folderNames: ['app', 'apps', 'App']},
            { name: 'folder-archive', folderNames: ['archive', 'backup']},
            { name: 'folder-batch', folderNames: ['batch', 'batchs']},
            ...
            { name: 'folder-examples', folderNames: ['example', 'examples', 'sample', 'samples', 'exemples', 'exemple']},
            ...
            { name: 'folder-generated', folderNames: ['generated', 'cfn-gen', 'gen', 'auto']},
