...
export const folderIcons: FolderTheme[] = [
    {
        ...
        icons: [
            ...
            { name: 'folder-ngrx-store', folderNames: ['store'], enabledFor: [IconPack.Angular, IconPack.Ngrx] },
            { name: 'folder-ngrx-state', folderNames: ['states', 'state'], enabledFor: [IconPack.Angular, IconPack.Ngrx] },
