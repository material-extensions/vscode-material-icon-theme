...
export const folderIcons: FolderTheme[] = [
    {
        ...
        icons: [
            ...
            { name: 'folder-batch', folderNames: ['batch', 'batchs', 'batches', '.venv', 'venv'] },
            ...
            { name: 'folder-functions', folderNames: ['function', 'functions', 'lambda', 'lambdas', 'logic', 'math', 'calc', 'calculation', 'calculations'] },
            ...
            { name: 'folder-packages', folderNames: ['package', 'packages', 'site-packages'] },
