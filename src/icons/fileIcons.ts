...
export const fileIcons: FileIcons = {
    ...
    icons: [
        ...
        { name: 'tox', fileNames: ['tox.ini', 'tox.exe'] },
        {
            name: 'routing',
        ...
        },
        {
            ...
            fileNames: ['requirements.txt', 'requirements-dev.txt', 'pipfile', '.python-version', 'manifest.in']
        },
        ...
        { name: 'verilog', fileExtensions: ['v', 'vhdl', 'vhd', 'sv', 'svh'] },
