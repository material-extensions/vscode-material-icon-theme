...
export const fileIcons: FileIcons = {
    ...
    icons: [
        ...
        { name: 'shader-vert', fileExtensions: ['vs', 'vert', 'vertexshader'] },
        { name: 'shader-geom', fileExtensions: ['gs', 'geom', 'geometryshader'] },
        { name: 'shader-frag', fileExtensions: ['fs', 'frag', 'fragmentshader'] },
    ]
};
